...
bool FramelessWidget::eventFilter(QObject* watched, QEvent* event)
{
	if (watched == ui->titleWidget)
	{
		...
		{
			on_toolButtonMaximized_clicked();
		}
	}
...
void FramelessWidget::on_toolButtonMinimized_clicked()
{
	this->showMinimized();

}

void FramelessWidget::on_toolButtonMaximized_clicked()
{
	this->isMaximized() ? this->showNormal() : this->showMaximized();
}

void FramelessWidget::on_toolButtonExit_clicked()
{
	this->close();
}
